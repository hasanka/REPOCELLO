...
<body>
	<div id="dialog-confirm" title="Remove User?" hidden="true">
		<p>
			<span class="ui-icon ui-icon-alert"
				style="float: left; margin: 0 7px 25px 0;"></span>This User will be
	...
	<div id="divMainPageOuter ">
		<div id="divMainPageContent" class="body-con">
				...
				<div id="searchUsers" role="Search Users"
					class="basicPanel  ">
					<table style="width: 100%;">
						<tr>
							<td><label for="firstName">First Name</label></td>
							<td><input type="text" id="txtFirstName" class="" /></td>
							<td><label for="lastName">Last Name</label></td>
							<td><input type="text" id="txtLastName" class="" /></td>
							<td><label for="email">Email</label></td>
							<td><input type="text" id="txtEmail" class="" /></td>
							<td><label for="userName">User Name</label></td>
							<td><input type="text" id="txtUserName" class="" /></td>
